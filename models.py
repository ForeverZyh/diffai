...
def CharLevelAGSub(c, **kargs):
    return n.Seq(n.EmbeddingWithSub(56, 64), n.Conv4Embed(64, 10, bias=True), n.AvgPool2D4Embed(10), n.ReduceToZono(), n.FFNN([64, 64, c], last_lin=True, last_zono=True, **kargs)) #
############# New Models
